...
const MOCK_POST: Post = {
  ...
  content: `Good writing is not about using big words or complex sentences. It is about saying what you mean as clearly as possible.

The best writers in the world are not the ones with the largest vocabularies. They are the ones who can take a complicated idea and explain it so simply that anyone can understand it.

Ernest Hemingway wrote in short sentences. George Orwell wrote rules for clarity. Both of them understood something that many writers never learn — the goal of writing is communication, not impression.

When you write to impress, you lose the reader. When you write to communicate, you keep them.

Start with what you want to say. Say it as simply as you can. Then stop.
...
That is the whole secret.`,
  ...
  author: { name: "Farhan Aziz", image: null },
